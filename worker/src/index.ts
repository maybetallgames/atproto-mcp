...
function clearAuthCookies(response: Response): Response { response.headers.append("Set-Cookie", clearCookie(CONSENT_COOKIE)); response.headers.append("Set-Cookie", clearCookie(GITHUB_STATE_COOKIE)); return response; }
